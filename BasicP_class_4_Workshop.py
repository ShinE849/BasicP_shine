...
yes = 1
no = 2
print("จะลิสหนังหรือซื้อตัว")
def show_movies(movie_list):
    movies = [{"movie": "Avengers endgame", "price": 200 , "Age restrictions": 3 },
             {"movie": "Fast and Furious 9", "price": 200, "Age restriction": 3},
             {"movie": "Interstella", "price": 200, "Age restriction": 3}]
